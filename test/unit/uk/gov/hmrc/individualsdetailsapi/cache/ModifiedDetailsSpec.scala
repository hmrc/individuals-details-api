...
package unit.uk.gov.hmrc.individualsdetailsapi.cache

import org.scalatest.matchers.should.Matchers
import org.scalatest.wordspec.AnyWordSpec
import play.api.libs.json.{Format, JsString, JsValue, Json}
import uk.gov.hmrc.individualsdetailsapi.cache.ModifiedDetails
...
class ModifiedDetailsSpec extends AnyWordSpec with Matchers {
  ...
  "ModifiedDetails JSON format" should {
    ...
    "serialize ModifiedDetails to JSON correctly" in {
      val now = Instant.parse("2025-11-03T14:33:11Z")
